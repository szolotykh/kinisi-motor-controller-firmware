...
// This command resets the controller for the specified motor. Ignored if the motor is currently owned by an active platform (one of its wheels).
...
typedef struct
{
    ...
    union {   //Union to support different properties of each command
        ...
        // RESET_MOTOR_CONTROLLER: This command resets the controller for the specified motor. Ignored if the motor is currently owned by an active platform (one of its wheels).
        struct {
