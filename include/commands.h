...
typedef struct
{
    ...
    union {   //Union to support different properties of each command
        ...
        // INITIALIZE_GPIO_PIN: This command sets the specified pin to a low state.
        struct {
            uint8_t pin_number; // The number of the pin to initialize.
            uint8_t mode; // Set digital pin as input or output. Awailable modes: 0 = INPUT, 0 = INPUT_PULLDOWN, 1 = INPUT_PULLUP, 2 = INPUT_NOPULL, 3 = OUTPUT.
        } initialize_gpio_pin;
